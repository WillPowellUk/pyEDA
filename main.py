...
def process_statistical(
    ...
    s_working_data, s_measures, gsrdata_segmentwise = segmentwise(
        data,
    ...
    for i in gsrdata_segmentwise:
        preprocessed_gsr.append(rolling_mean(i, 1.0 / new_sample_rate, new_sample_rate))
    ...
    for i in preprocessed_gsr:
        working_data, measures = statistical_feature_extraction(
            i, new_sample_rate, use_scipy=use_scipy
        )
...
def prepare_automatic(
    ...
    for i in gsr_signal:
        ...
        preprocessed_gsr.append(
            rolling_mean(data, 1.0 / new_sample_rate, new_sample_rate)
        )
